...
if not st.session_state.setup_complete:
    ...
    st.session_state['experience']  = st.text_area(label="Experience", value = st.session_state['experience'] , max_chars=200, placeholder="Describe your experience")
    ...
    with col2:
        st.session_state['position'] = st.selectbox(
            'Choose position',
            options=['Software Engineer', 'Data Scientist', 'Product Manager', 'AI Engineer', 'Data Analyst']
        )

    st.session_state['company'] = st.selectbox(
        'Choose company',
        options=['Google', 'Amazon', 'Facebook', 'Apple', 'Microsoft']
    )
